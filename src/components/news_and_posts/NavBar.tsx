...
const NavBar: React.FC = () => {
    ...
    return (
        <div className="fixed top-0 left-0 right-0 w-screen z-50">
            <NavigationMenu className="flex w-full max-w-full items-center justify-between p-4 bg-white shadow-md">
                <NavigationMenuList className="flex items-center space-x-2 w-[200px]">
